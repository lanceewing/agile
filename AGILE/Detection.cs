...
namespace AGILE
{
    ...
    {
        /// <summary>
        /// The short ID of the game, as known by the AGILE interpreter, e.g. KQ4
        /// </summary>
        ...
        /// </summary>
        public bool HasAGIMouse { get; }

        /// <summary>
        /// If the game requires the AGIPAL hack.
        /// </summary>
        public bool HasAGIPal { get; }
        ...
        public Detection(Game game)
        {
            try
            {
                ...
                {
                    if (gameDefinitions[i, 3] == md5HashString)
                    {
                        GameId = gameDefinitions[i, 1];
                        GameName = gameDefinitions[i, 2];

                        String flags = gameDefinitions[i, 0];
